              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Persona <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button></h1>
                          ...
                          <div class="form-group col-lg-12">
                            ...
                            <div class="form-group col-lg-6">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="apellidos" id="apellidos" maxlength="100" placeholder="Apellido del proveedor" required>
                              </div>
                              <div class="form-group">
                                <label>Email:</label>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/scriptPPersona.js"></script>
